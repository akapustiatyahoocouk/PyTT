""" An SQL DELETE statement, perhaps parameterised. """
...
class SqlDeleteStatement(SqlStatement):
    ...
    def __init__(self, db: SqlDatabase, sql_template: str):
        """
            Constructs the SQL DELETE statement from a 
            ...
            @param db:
                ...
                is applicable.
            @param sql_template:
                The SQL DELETE statement template (database 
                engine - neutral).
            @raise DatabaseError:
    ...
    def execute(self) -> int:
        """
            Executes this SQL DELETE statement.
