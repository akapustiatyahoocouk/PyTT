...
##########
#   Public entities
class PublicTasksViewSettingsMeta(type):
    """ The metaclass for PublicTasksViewSettings which implements
    ...
    def __init__(cls, *args, **kwargs):
        ...
        cls.__impl = Settings.get("PublicTasksView")
...
@final
class PublicTasksViewSettings(metaclass=PublicTasksViewSettingsMeta):
    """ Persistent settings. """
