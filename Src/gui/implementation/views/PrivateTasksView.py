...
class PrivateTasksView(View):
    ...
    def __apply_default_locale(self) -> None:
        self.__create_public_task_button.text = GuiResources.string("PrivateTasksViewEditor.CreatePrivateTaskButton.Text")
        self.__modify_public_task_button.text = GuiResources.string("PrivateTasksViewEditor.ModifyPrivateTaskButton.Text")
        self.__destroy_public_task_button.text = GuiResources.string("PrivateTasksViewEditor.DestroyPrivateTaskButton.Text")
