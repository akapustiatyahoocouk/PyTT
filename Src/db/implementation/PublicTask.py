...
class PublicTask(PublicActivity, Task):
    ...
    NAME_PROPERTY_NAME = PublicActivity.NAME_PROPERTY_NAME
    DESCRIPTION_PROPERTY_NAME = PublicActivity.DESCRIPTION_PROPERTY_NAME
    TIMEOUT_PROPERTY_NAME = PublicActivity.TIMEOUT_PROPERTY_NAME
    REQUIRE_COMMENT_ON_START_PROPERTY_NAME = PublicActivity.REQUIRE_COMMENT_ON_START_PROPERTY_NAME
    REQUIRE_COMMENT_ON_FINISH_PROPERTY_NAME = PublicActivity.REQUIRE_COMMENT_ON_FINISH_PROPERTY_NAME
    FULL_SCREEN_REMINDER_PROPERTY_NAME = PublicActivity.FULL_SCREEN_REMINDER_PROPERTY_NAME
    ACTIVITY_TYPE_ASSOCIATION_NAME = PublicActivity.ACTIVITY_TYPE_ASSOCIATION_NAME
