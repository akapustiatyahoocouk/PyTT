...
INSERT INTO [constraints] SELECT COUNT(*)-1 FROM PRAGMA_TABLE_INFO('public_activities') WHERE NAME='pk' AND type='INTEGER';
...
INSERT INTO [constraints] SELECT COUNT(*)-1 FROM PRAGMA_TABLE_INFO('private_activities') WHERE NAME='pk' AND type='INTEGER';
INSERT INTO [constraints] SELECT COUNT(*)-1 FROM PRAGMA_TABLE_INFO('private_activities') WHERE NAME='fk_owner' AND type='INTEGER';
